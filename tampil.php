...
<!DOCTYPE html>
	...
	<body>
		<h5 style="font-variant: normal; font-family: serif">Selamat Datang <?php echo $_SESSION['username']; ?></h5>
 	 <br>	
 	 <div class="container">
...
<!-- 		      <li class="nav-item active">
		...
		<table class="table table-striped table-skylightblue">
			<tr>
				...
				<td> Tahun Barang </td>
				<td> Harga Barang </td>
				<td colspan="2" style="text-align:center;"> Pilih</td>
			</tr>
			<?php
				include 'connect.php';
				...
				while ($a=mysqli_fetch_array($query)) {
					...
					<tr>
						...
						<td style="text-align:center;">
							<a href="delete.php?id=<?=$a['kode_barang']?>"><button type="button" class="btn btn-primary">Hapus</button></a>
						</td>
						<td  style="text-align:center;">
